...
- [Essential Commands](#essential-commands)
  ...
  - [Login and Console Access](#login-and-console-access)
    - [Local Console Login](#local-console-login)
  ...
  - [Links (Hard and Soft)](#links-hard-and-soft)
  ...
  - [Searching for Files](#searching-for-files)
    ...
    - [Other Search Commands](#other-search-commands)
  - [Text File Content Viewing](#text-file-content-viewing)
    - [Basic Viewing Commands](#basic-viewing-commands)
    - [Pagers](#pagers)
  ...
  - [Vi/Vim Text Editor](#vivim-text-editor)
    - [Modes](#modes)
    - [Basic Commands](#basic-commands)
  - [Archive, Compression, and Backup](#archive-compression-and-backup)
